...
# OR
docker run -d --restart always -p 33333:8080 --name mypypi pypiserver/pypiserver:latest -P htpasswd packages
```
...
export PIP_EXTRA_INDEX_URL=http://localhost:28888/simple/
