...
exit 0
#
# 如果要上傳大型檔案, 務必使用 multi-part upload
#
# -------------------------------------------------------------------------------------------------------------------
