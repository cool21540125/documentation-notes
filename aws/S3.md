...
- Durability & Availability
    - Durability   : 99.999999999% (11 9's), 表示儲存在 S3 1000w 個 objects, 放個 10000 years, 會有一個壞掉
    - Availability : 99.99%, 表示一年大概有 53 mins 為 not vaailable
...
- ![S3 Moving Storage Classes](./img/MovingBetweenStorageClasses.png)
    - From Course https://www.datacumulus.com/
...
- 可針對 S3 的 events 設定後續動作
    - upload, delete, ...
- 關於 S3 的相關 events 的後續動作, 可以設定 
    - Event Notifications 
        - (比較單純), 後面可 pipeline 到:
            - SNS
            - SQS
