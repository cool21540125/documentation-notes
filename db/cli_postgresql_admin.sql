...
GRANT USAGE, CREATE ON SCHEMA YOUR_SCHEMA TO app_user;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA YOUR_SCHEMA TO app_user;

-- 讓 YOUR_SCHEMA 將來直接具備 default privileges
ALTER DEFAULT PRIVILEGES IN SCHEMA YOUR_SCHEMA GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO app_user;
